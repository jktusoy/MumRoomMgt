...
<<<<<<< HEAD
    <div id="main">
        <div id="header">
       <img src="<c:url value="${etc/images/logo-icon-transparent.svg}"/>"/>
            
        <h3>MUM Room Management Software System</h3>
        </div>
=======
	<div id="main">
		<div id="header">
...
<<<<<<< HEAD
        ...
        <div id="footer">
            <p class="copyright">Copyright © 2010 to Joseph Tusoy, Binyam  Heyi and William Chapparo. 
                All rights reserved. This website is made in partial fulfillment
