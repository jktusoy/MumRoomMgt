...
FF, IA
 ...
 <head>
     ...
     <link rel="stylesheet" href="../etc/css/studentProfile.css">
                         ...
                         <form>
                             <div class="col-sm-12">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-sm-4 form-group">
                                         ...
                                         <input type="text" placeholder="Room Number.." class="form-control">
                                     </div>	
                             ...
                             <div class="row items">
                                ...
                                <div class="row items">
                                       ...
                                       <div class="col-sm-4 form-group"> 
                                               ...
                                               <div class="form-check">
                                                   <div>
                                                     ...
                                                     <div class="form-check disabled">
                                                       <input class="form-check-input" type="radio" name="exampleRadios4" id="exampleRadios3" value="option3">
                                                       <label class="form-check-label" for="exampleRadios">
                                                         Absent
                                                       </label>
                                                     </div>
                                 ...
                                 <br>   
                            <input type="checkbox" name="checkbox" value="check" id="agree" /> I have read and agree to the Terms and Conditions of the residence life.
                             <br>
